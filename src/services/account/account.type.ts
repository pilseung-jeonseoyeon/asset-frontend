...
//
// 2026-08-30 백엔드 계약 변경(라이브 OpenAPI AccountRes/AccountDetailRes 대조):
...
export interface AccountResponse {
  ...
  /**
   * 이름은 '등록 시점'이지만 2026-08-30 OpenAPI 설명은 "현재 달러 예수금 — 등록 시점 값에서 시작해
...
/**
 * GET /accounts/{accountId} 전용 응답(2026-08-30 계약). 계좌 정보와 예수금은 `account` 안에 들어가고,
 ...
 *
 * **거절 조건은 통화(currency)가 아니라 외화 예수금 유무다**(2026-08-30 OpenAPI 설명 확인):
