// 자산 화면 '부동산' 칸의 안내 모달.
//
// 왜 모달인가: 부동산은 **서버에 자산군 자체가 없다**(AssetClass는 STOCK/DEPOSIT/CRYPTO/CASH/ETC
// 5종뿐이다). 등록도 조회도 되지 않으므로 자산군 카드처럼 계좌 목록(AssetCategoryModal)을 열면
// 영원히 비어 있는 화면이 된다. 대신 '아직 준비 중'이라는 사실만 분명히 알린다 — 이 저장소는
// 서버에 없는 값을 있는 것처럼 그리지 않는다.
//
